...
function Business() {
  ...
  const filteredBusinesses = businesses.filter(
    (bsns) =>
      ...
      bsns.businessStatus.toLowerCase().includes(searchTerm.toLowerCase())
  );
    ...
    <div className="business-container">
      ...
      <div className="bsns-form">
        <form onSubmit={handleSubmit}>
          ...
          <button className="bsns-form-btn" type="submit">
      ...
      <div className="handle-bsns">
        ...
        <button className="bsns-btn-del-all" onClick={handleDeleteAll}>
          ...
          {filteredBusinesses.length > 0 ? (
            filteredBusinesses.map((business) => (
              <tr key={business.id}>
                ...
                <td>
                  <div className={borderStatus(business.businessStatus)}>
